...
function platteTekst(antwoorden, verzondenOp) {
  ...
  stukken.push(
    '',
    'Wat gebeurt er nu?',
    'We beoordelen je aanvraag aan de hand van ons beoordelingskader. Je hoort van ons of we een',
    'Microsoft 365 Copilot-licentie voor je afsluiten, of dat we dat (nog) niet doen.',
    '',
